...
| `src/app/login/page.tsx`                 | Public sign-in screen and programme introduction.                                                                                                                                               |
...
| `src/app/(protected)/students/page.tsx`  | Staff-only table of students, approved activities, and earned badges.                                                                                                                           |
...
| `src/app/actions/auth.ts`                | Validates email/password sign-in, maps Supabase Auth error codes to controlled message keys, signs out, and redirects after either action.                                                      |
...
| `src/components/auth/login-form.tsx`             | Accessible client form connected to the sign-in Server Action, including pending and error states.                                            |
