...
| `src/components/auth/login-form.tsx`             | Accessible client form connected to the sign-in Server Action, accepting an email or username, including pending and error states.                                                          |
